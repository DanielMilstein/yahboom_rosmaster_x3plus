...
Model: YDLIDAR 4ROS (confirmed on the unit 2026-07-09) — 512000 baud,
TOF protocol; the parameter block below mirrors the driver's TG-family
reference config (ydlidar_ros2_driver/params/TG.yaml).
        ...
        parameters=[
            {
                ...
                # YDLIDAR 4ROS: 512000-baud TOF unit — values mirror the
                # driver's own TG-family reference (params/TG.yaml).
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description="YDLIDAR 4ROS (TOF) serial baudrate.",
            ),
